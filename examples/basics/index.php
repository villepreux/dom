...
use function dom\{html,head,head_boilerplate,body,rss,jsonfeed,main,footer,article,aside,h2,grid,p,img,a}; // Markup
use function dom\{card,card_title,card_media,card_text}; // Cards
use function dom\{svg_rss,svg_facebook}; // SVGs
use function dom\{toolbar,toolbar_styles}; // Toolbar plugin
...
output( // Output
    html( // HTML document
        head(
            head_boilerplate().
            toolbar_styles()). // Plugin usage example
        body(
            toolbar("Example!"). // Using the toolbar plugin custom component
